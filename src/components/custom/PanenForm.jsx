...
const panenSchema = z.object({
    ...
    jumlah_produksi: z.number().min(1, { message: 'Jumlah panen tidak boleh kosong' })
});
                        ...
                        <Form {...control}>
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 mb-6">
                                                        ...
                                                        <FormControl>
                                                            <SelectTrigger className="w-full">
                                                                <SelectValue placeholder="Daftar Varietas">
                                                                    {field.value ? varietasData.find(v => v.id === field.value).nama_varietas : "Daftar Varietas"}
                                                                </SelectValue>
                                                            </SelectTrigger>
                                                        </FormControl>
                                                        <SelectContent>
                                                        {varietasData.map((varietas) => (
                                                                <SelectItem key={varietas.id} value={varietas.id}>
                                ...
                                <Button
                                    ...
                                    onClick={() => append({ id_varietas: '', jumlah_produksi: '' })}
                                >
