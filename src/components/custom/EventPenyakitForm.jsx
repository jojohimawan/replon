                        ...
                        <Form {...control}>
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 mb-6">
                                {fields.map((field, index) => (
                                    <div key={field.id}>
                                        <h3 className='text-xl font-bold'>Event Penyakit / Hama ke: {index + 1}</h3>
                                        <FormField
                                            control={control}
                                                        ...
                                                        <FormControl>
                                                            <SelectTrigger className="w-full">
                                                                <SelectValue placeholder="Daftar Penyakit / Hama">
                                                                    {field.value ? penyakitData.find(v => v.id === field.value).nama_penyakit : "Daftar Penyakit / Hama"}
                                                                </SelectValue>
                                                            </SelectTrigger>
                                                        </FormControl>
                                                        <SelectContent>
                                                        {penyakitData.map((penyakit) => (
                                                                <SelectItem key={penyakit.id} value={penyakit.id}>
